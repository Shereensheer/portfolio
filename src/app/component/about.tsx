export const About = () => (
  <section id="about" className="py-16 sm:py-24 text-white">
    <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
      
      {/* Heading: Centered with underline */}
      <h3 className="text-3xl sm:text-4xl font-extrabold mb-8 tracking-wide relative mx-auto w-fit after:content-[''] after:block after:w-20 after:h-1 after:bg-cyan-300 after:mx-auto after:mt-2">
        👩‍💻 About Me
      </h3>
      ...
      <div className="bg-white/5 backdrop-blur-sm p-4 sm:p-6 rounded-xl shadow-lg transition duration-300 hover:shadow-cyan-500/30 text-gray-300 text-left text-sm sm:text-base leading-relaxed space-y-4">
        ...
        <p>
          My journey started with full-stack development and has now evolved toward Agentic AI systems — smart, context-aware, and autonomous applications.
        </p>
